...
export default function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      desc: 'The proof and a unique nullifier are recorded on the Midnight blockchain. The nullifier prevents double-submissions. Your identity and signal text never touch the ledger.',
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <main className="main-content">
      <div className="content-wrapper animate-fade-in" style={{ maxWidth: '800px' }}>
        ...
        <div className="soft-panel" style={{ marginTop: '3rem', padding: '2rem', textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', marginBottom: '1rem' }}>Connect your wallet and submit your first private signal.</p>
          <a href="/" className="primary-button" style={{ display: 'inline-block', textDecoration: 'none' }}>Broadcast Signal →</a>
        </div>
      </div>
    </main>
  );
