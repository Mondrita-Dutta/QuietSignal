    ...
    <main className="main-content">
      <div className="content-wrapper animate-fade-in" style={{ maxWidth: '800px' }}>
        ...
        <p className="hero-subtitle" style={{ marginBottom: '3rem' }}>
          Collect trustworthy, verified signal without compromising participant privacy.
        </p>

        {/* Value Props */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
          {[
            { title: 'Honest Responses', desc: 'Participants know their identity is mathematically protected, leading to more candid signal.', icon: '💬' },
        ...
        <div className="soft-panel" style={{ padding: '2rem', textAlign: 'center' }}>
          <h3 style={{ fontSize: '1.2rem', marginBottom: '0.5rem' }}>Interested in deploying QUIETSIGNAL?</h3>
          <p style={{ color: 'var(--text-secondary)', marginBottom: '1rem' }}>
            Contact us to set up private, verifiable signal for your organization.
          </p>
