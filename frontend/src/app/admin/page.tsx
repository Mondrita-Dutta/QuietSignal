    ...
    return (
      <div style={{ padding: '60px 20px', textAlign: 'center', maxWidth: '600px', margin: '0 auto' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem' }}>
          Please connect your 1A.M. or Lace wallet on the Preprod network to deploy the latest QUIETSIGNAL contract.
        </p>
  ...
  return (
    <div style={{ padding: '40px 20px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <p style={{ color: 'var(--text-secondary)', marginBottom: '3rem' }}>
        Deploy a new instance of the QUIETSIGNAL survey contract to Midnight Preprod.
      </p>
